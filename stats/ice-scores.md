...
| 2 | #1335 | RESEARCH: fruit-agent-orchestrate missed live worktree claims and double-booked #1322 | 2 | 0.8 | 5 | 8.0000 | Y |
| 3 | #938 | TRACKER: apply issue-review-skill to open issues — quality/accessibility/actionability pass | 1 | 0.8 | 7 | 5.6000 | Y |
| 4 | #948 |  | 1 | 0.8 | 7 | 5.6000 | Y |
| 5 | #587 | Potato Token Testing suite — benchmark .a + two fuzz scripts | 1 | 0.8 | 5 | 4.0000 | Y |
| 6 | #590 | DEV: Potato input testing — per-stdin-prompt fuzzer, reverse order, oracle parity (on-demand) | 1 | 0.8 | 5 | 4.0000 | Y |
| 7 | #677 | TRACKER: browser playground on GitHub Pages — textarea assembly execution | 1 | 0.8 | 5 | 4.0000 | N |
| 8 | #707 | PM: track web front-end feature parity — LCCjs browser vs web_ilcc dashboard | 1 | 0.8 | 5 | 4.0000 | N |
| 9 | #890 | TRACKER: skill-inventory improvements from #886 audit — A through H | 1 | 0.8 | 5 | 4.0000 | Y |
| 10 | #891 | TRACKER: add "did you mean?" suggestions to verbose error messages — full coverage | 1 | 0.8 | 5 | 4.0000 | Y |
| 11 | #1088 | DEV: ilcc — 'g' run-to-end + minimal breakpoints (bp {addr|label}) | 1 | 0.8 | 5 | 4.0000 | Y |
| 12 | #1105 | research(process): audit agent HONEYDEW's Hermes skill-port work (#1066–#1073) [TRACKER] | 1 | 0.8 | 5 | 4.0000 | Y |
| 13 | #1133 | bug: velocity-log numeric metrics are defined/validated inconsistently — unclear sign conventions, no validation on h/c/actual, doc vs code mismatch on delta_h_min | 1 | 0.8 | 5 | 4.0000 | Y |
| 14 | #1177 | process: stop source edits + builds on the shared main checkout (clean-gate + worktree discipline) | 1 | 0.8 | 5 | 4.0000 | Y |
| 15 | #1180 | process(pm): triage claude-bugs-audit-2026-06-06.md findings into actionable investigation tickets | 1 | 0.8 | 5 | 4.0000 | Y |
| 16 | #1189 |  | 1 | 0.8 | 5 | 4.0000 | Y |
| 17 | #1211 | TRACKER: fruit-agent-orchestrate improvement cluster — sequencing + efficacy gate for #810 | 1 | 0.8 | 5 | 4.0000 | Y |
| 18 | #1320 | TRACKER: ICE scoring is built but orphaned — re-adopt for triage/orchestration prioritization | 1 | 0.8 | 5 | 4.0000 | Y |
| 19 | #1322 | process(ice): keep ICE scores current — score new tickets at file time or via periodic sweep | 1 | 0.8 | 5 | 4.0000 | Y |
| 20 | #1323 | feat(skills): wire ice_score into puzzle-triage ranking (and fruit-agent-orchestrate) | 1 | 0.8 | 5 | 4.0000 | Y |
| 21 | #1332 | feat(skills): convert fruit-agent-orchestrate to Hermes skill format | 1 | 0.8 | 5 | 4.0000 | Y |
| 22 | #1333 | BUG: sandbox page theme colors do not fully follow code theme | 1 | 0.8 | 5 | 4.0000 | Y |
| 23 | #1334 | BUG: docs pages ignore the current theme toggle and force light mode | 1 | 0.8 | 5 | 4.0000 | Y |
| 24 | #1336 | REVIEW #1094 — docs(test-runner): teacher/student usage guide for lcc --test | 1 | 0.8 | 5 | 4.0000 | Y |
| 25 | #1050 | docs(workflow): clarify ad-hoc/unclaimed time-consuming work still gets a velocity row | 0.5 | 1 | 7 | 3.5000 | Y |
| 26 | #1056 | chore(docs): commit the deep-code-review brainstorm + annotate it as triaged via #931 | 0.5 | 1 | 7 | 3.5000 | Y |
| 27 | #1057 | chore(docs): commit improving-data-analysis-research.md + annotate its lineage (origin + follow-ups #981/#982/#983) | 0.5 | 1 | 7 | 3.5000 | Y |
| 28 | #1063 | docs(oracle-parity): correct stale 'auto-skip' claim + add stdout-mirroring convention | 0.5 | 1 | 7 | 3.5000 | Y |
| 29 | #1192 | docs: add 'verify the load-bearing premise before ratifying a superseding decision' to do-this-not-that.md | 0.5 | 1 | 7 | 3.5000 | Y |
| 30 | #1242 | docs(do-this-not-that): add 'check current main before chasing a worktree test red' diagnostic | 0.5 | 1 | 7 | 3.5000 | Y |
| 31 | #1311 | docs(do-this-not-that): probe the real CLI before asserting; verify end-to-end | 0.5 | 1 | 7 | 3.5000 | Y |
| 32 | #1316 | next-best-action skill frontmatter still says "run before every close" — contradicts the #1279 approval gate | 0.5 | 1 | 7 | 3.5000 | Y |
| 33 | #507 | PM: send long-line silent-split report to Prof. Dos Reis (OG BUG #13) | 0.5 | 0.8 | 7 | 2.8000 | N |
| 34 | #741 | orientation.md Mermaid diagrams lack a readability/quality/accessibility review | 0.5 | 0.8 | 7 | 2.8000 | Y |
| 35 | #757 | demo-034 restructuring for testability may have dropped its .global/linker-startup teaching intent | 0.5 | 0.8 | 7 | 2.8000 | Y |
| 36 | #1049 | docs(workflow): add proportional consent threshold for ad-hoc investigation | 0.5 | 0.8 | 7 | 2.8000 | Y |
| 37 | #1062 | claude_workflow.md Protocol A's final 'npm run close B' hits the same branch-gate as #1052 | 0.5 | 0.8 | 7 | 2.8000 | Y |
| 38 | #1094 | docs(test-runner): teacher/student usage guide for lcc --test | 0.5 | 0.8 | 7 | 2.8000 | Y |
| 39 | #1166 | refactor(skills): suffix Hermes-specific skills with -hermes for disambiguation | 0.5 | 0.8 | 7 | 2.8000 | Y |
| 40 | #1179 | docs: single discoverable index for worktree & multi-agent concurrency footguns | 0.5 | 0.8 | 7 | 2.8000 | Y |
| 41 | #1265 | REVIEW: apply issue-review-skill to #1238 (resetAssemblyState listingLoadPoint leak) | 0.5 | 0.8 | 7 | 2.8000 | Y |
| 42 | #1266 | REVIEW: apply issue-review-skill to #1102 (--explain forwarding in LCC+ driver) | 0.5 | 0.8 | 7 | 2.8000 | Y |
| 43 | #1271 | Hermes-only tickets have no runtime label — Claude Code agents can claim+stall on them (add runtime:hermes) | 0.5 | 0.8 | 7 | 2.8000 | Y |
| 44 | #1276 | REVIEW #1093 — test(test-runner): e2e suite for --test mode | 0.5 | 0.8 | 7 | 2.8000 | Y |
