#!/usr/bin/env node
/**
 * velocity-export.js — export ~/.lccjs/lccjs.db → docs/puzzle-velocity.csv.
 *
...
function exportCSV({ force = false } = {}) {
  ...
  const lines = [
    '# AUTO-GENERATED by scripts/velocity-export.js — do not edit directly. Source: ~/.lccjs/lccjs.db',
    COLS.join(','),
    ...rows.map(encodeRow),
  ];
