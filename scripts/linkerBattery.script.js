...
const argsForAllTests = [
    ['node', './test/linker.script.js', './demos/startup.o', './demos/m1.o', './demos/m2.o', 'textbook example'],
    ['node', './test/linker.script.js', './demos/s1.o', './demos/s2.o', 'custom example1'],
    ['node', './test/linker.script.js', './demos/start.o', './demos/r1.o', './demos/r2.o', 'custom example2'],
    // Add more test cases as needed
];

function parseTestArguments(testArgs) {
    // Remove 'node' and './test/linker.script.js' and the last element (the comment)
