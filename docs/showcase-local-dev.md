...
## The one thing to get right: serve the GENERATED page, not the source

There are two different files, and only one is deployed:

| File | What it is | Deployed? |
|------|------------|-----------|
| `docs/showcase/index.html` | Standalone "Syntax Highlight Showcase" source page | ❌ No |
...
Serving `docs/` (as opposed to `docs/site/`) would test the standalone source page —
the exact mix-up behind #985/#986. Always serve `docs/site`.
