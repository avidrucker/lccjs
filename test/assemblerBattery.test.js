...
const argsForAllTests = [
  ...
  ['node', './test/assembler.test.js', './demos/demoD.a', 'assembling mov, mvi, and mvr instructions'],
  ['node', './test/assembler.test.js', './demos/demoE.a', 'assembling push, pop, custom function definitions and calls'],
  ['node', './test/assembler.test.js', './demos/demoF.a', 'assembling various output commands (decimal, hex, and char)'],
  ['node', './test/assembler.test.js', './demos/demoG.a', 'g', '-5', 'ff', 'assembling various user input commands (decimal, hex, and char)'],
  ['node', './test/assembler.test.js', './demos/demoH.a', 'assembling negative number args in mov, add, and .word'],
  ['node', './test/assembler.test.js', './demos/demoI.a', 'assembling branching and looping commands'],
  // ['node', './test/assembler.test.js', './demos/demoJ.a'], // demoJ is disabled atm, will reactivate later to test infinite loop detection
  ['node', './test/assembler.test.js', './demos/demoK.a', 'assembling m command'],
  ['node', './test/assembler.test.js', './demos/demoL.a', 'assembling r command'],
  ['node', './test/assembler.test.js', './demos/demoM.a', 'assembling s command'],
  ['node', './test/assembler.test.js', './demos/demoN.a', 'assembling div'],
  ['node', './test/assembler.test.js', './demos/demoO.a', 'cheese', 'assembling IO commands'],
  ['node', './test/assembler.test.js', './demos/demoP.a', 'assembling .start and interleaved data in instructions'],
