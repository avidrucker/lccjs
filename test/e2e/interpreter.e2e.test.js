...
const testCases = [
  ...
  { eFile: './demos/demoY.e', userInputs: [], comment: 'interpreting label offsets for ld and .word directives'},
  { eFile: './demos/demoZ.e', userInputs: [], comment: 'interpreting label offsets for st, br, and lea instructions'},
];
