...
- [x] de-confound the velocity over-time drift signal — switch §1 day-bucketing UTC→HST and decide whether TEST needs its own correction constant (for a human; surfaced by the #206 re-run)
